...
<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300">
  <div className="bg-slate-850 border border-white/10 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] relative">
    ...
    <div className="flex-1 overflow-y-auto p-6 custom-scrollbar relative">
      <form className="mb-8 animate-in fade-in slide-in-from-bottom-4">
        ...
        <div className="relative group">
          ...
          <button
            type="submit"
            className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-xl transition-all flex items-center justify-center shadow-lg bg-[var(--color-primary)] hover:brightness-110 text-[var(--color-primary-foreground)] shadow-[var(--color-primary)]/20"
            onClick={() => cambiarVista('cconsultarctresultados')}
